 ...
 * @author acer
 */
public class MessageCopy extends javax.swing.JFrame {
	...
	public MessageCopy() {
        ...
        JFrame jf = null;
	public MessageCopy(JFrame jf, String message, String title) {
		this();
		this.jf = jf;
		jf.setEnabled(false);
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(MessageCopy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
